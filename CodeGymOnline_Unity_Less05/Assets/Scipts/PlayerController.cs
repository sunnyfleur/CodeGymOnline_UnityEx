...
public class PlayerController : PlayerControllerAbstract
{
    ...
    protected override void MoveObject()
    {
        ...
        Vector3 moveDirection = targetPosition - transform.parent.position;
        ...
        if (distance > 0.1f)
        {
            ...
            transform.parent.position = Vector3.MoveTowards(transform.parent.position, currentTarget.position, objectSpeed * Time.deltaTime);
        }
        else
        {
            // Chuy?n target
